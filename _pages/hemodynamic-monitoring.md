...
header:
  ...
  caption: "(Team photo - I am in the middle getting snacks)"
  actions:
...
<div style="text-align: center;">
  <img src="/images/swan.png" alt="Swan" style="max-width: 65%; height: auto; border-radius: 10px;">
  <p><em>Diagram of the Swan-Ganz catheter and some hemodynamic parameters</em></p>
</div>
